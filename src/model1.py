...
def create_connections(network=None, charging_mode=True, temp=None):
    ...
    if charging_mode:
        ...
        c4 = Connection(hx1, 'out2', hx2, 'in2', label='4')
        c5 = Connection(hx2, 'out2', cd, 'in2', label='5')
        c6 = Connection(cd, 'out2', va, 'in1', label='6')
        ...
        c21 = Connection(sso, "out1", cd, "in1", label='21')
        c22 = Connection(cd, "out1", hx2, "in1", label="22")
        c23 = Connection(hx2, "out1", hx1, "in1", label="23")
        ...
        # Storage connection
        c24.set_attr(m=10, T=temp, fluid={"water": 1}) # T=40 for model with environment temp setting
        c21.set_attr(T=50)
        # main connection
        ...
        p.set_attr(eta_s=0.8, P=1e3)
        ph.set_attr(pr1=0.98, pr2=0.98, ttd_l=20)
        ev.set_attr(pr1=0.98, pr2=0.98, ttd_u=15)
        ...
        network.solve(mode='design')
        nw.print_results()
    return network, cd, hx1, hx2, cp, c22, c23, c4, c5
