...
rc_c5 = Connection(rc_preheater, 'out1', rc_superHeater, 'in1', label='RC5')
...
rc_storage_c22 = Connection(rc_evaporator, 'out2', rc_preheater, 'in2', label='RC_sto: ev to ph')
rc_storage_c23 = Connection(rc_preheater, 'out2', rc_storage_sink, 'in1', label='RC_sto: ph to sink')
...
rc_superHeater.set_attr(pr1=0.98, pr2=0.9)
...
# rc_storage_c23.set_attr(T=sto_c5.T.val, p=sto_c5.p.val)
rc_c1.set_attr(m=10, p=22, T=400, fluid={'Ethanol': 1})
rc_c2.set_attr(p=1)
